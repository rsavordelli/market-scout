...
from market_scout.base_models import HistoricalData, TradingOpportunity
from market_scout.models.naive_model import NaiveModel
...
class TestNaiveModel:
    ...
    def test_insufficient_data_returns_empty_list(self):
        ...
        data = HistoricalData(symbol="TEST", data=df, retrieved_at=datetime.now())
